  ...
  return (
    <div className='p-7 pb-0 card'>
      ...
      <p className='text-gray-700 dark:text-gray-300'>
        Desarrollador full-stack con foco en backend (Node.js/NestJS, Java/Spring Boot, PHP/Laravel) y <span className='font-semibold mr-1'>AWS</span>
        (arquitecturas serverless y en contenedores). En frontend, dominio avanzado de React y Next.js, con experiencia adicional en Vue y Angular.
        Trabajo con Spec-Driven Development apoyado en <span className='font-semibold'>IA</span> para mantener contratos claros entre servicios y
      ...
      <div className='flex flex-row flex-wrap justify-between items-end space-y-2'>
        ...
        <ul className='flex space-x-5 text-gray-600 dark:text-gray-100'>
          <li>
            <a href='https://github.com/chaicopadillag' target='_blank' className='hover:text-primary-600 transition-all dark:hover:text-gray-500'>
