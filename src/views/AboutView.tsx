    ...
    <div className='p-7 pb-0 card'>
      ...
      <div className='flex flex-row flex-wrap justify-between items-end space-y-2'>
        <a
          ...
          target='_blank'
          className='flex items-center font-medium text-violet-500 hover:text-violet-600 dark:text-gray-300 dark:hover:text-gray-200 '
        >
        ...
        <ul className='flex space-x-5 text-gray-600'>
          <li>
            <a href='https://github.com/chaicopadillag' target='_blank' className='hover:text-violet-600 transition-all dark:hover:text-gray-900'>
          ...
          <li>
            <a href='https://www.linkedin.com/in/chaicopadillag/' target='_blank' className='hover:text-violet-600 transition-all dark:hover:text-gray-900'>
          ...
          <li>
            <a href='https://www.facebook.com/chaicopadillag' target='_blank' className='hover:text-violet-600 transition-all dark:hover:text-gray-900'>
          ...
          <li>
            <a href='https://twitter.com/chaicopadillag' target='_blank' className='hover:text-violet-600 transition-all dark:hover:text-gray-900'>
          ...
          <li>
            <a href='https://www.instagram.com/chaicopadillag/' target='_blank' className='hover:text-violet-600 transition-all dark:hover:text-gray-900'>
