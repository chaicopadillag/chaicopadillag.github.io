  ...
  return (
    <div className='p-7 pb-0 card'>
      ...
      <p className='text-gray-600 dark:text-gray-300 mb-4'>
        Soy Desarrollador Web autodidacta, proactivo y eficaz de Huánuco, Perú. Me apasiona mucho
        trabajar con nuevas tecnologías, disfruto creando aplicaciones de alto rendimiento tanto en
        Backend como en Frontend. Contribuyo a proyectos de Open-source y comunidades de
        programación ayudando a otros usuarios.
        <br />
        Actualmente me dedico al desarrollo de aplicaciones web que ayuden a solucionar los diversos
        problemas que aquejan al mundo de hoy. <br /> ¿Interesado por mis conocimientos y
        habilidades? ¡Quizás podamos trabajar juntos!
      </p>
      <div className='flex flex-row flex-wrap justify-between items-end space-y-2'>
        ...
        <ul className='flex space-x-5 text-gray-600'>
          ...
          <li>
            <a
              href='https://www.instagram.com/chaicopadillag/'
              target='_blank'
              className='hover:text-primary-600 transition-all dark:hover:text-gray-900'
            >
              <svg
