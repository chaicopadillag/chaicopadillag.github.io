      ...
      <div className='flex flex-wrap justify-between'>
        <div className='space-y-1.5'>
          ...
          <div className='flex flex-wrap gap-2'>
            <div className='flex w-auto items-center font-medium text-sm text-gray-400'>
              <svg xmlns='http://www.w3.org/2000/svg' fill='currentColor' className='w-4 h-4 text-primary-400 dark:text-gray-300' viewBox='0 0 16 16'>
        ...
        <div className='space-y-2 sm:text-right pt-1 sm:pt-0'>
          <div className='bg-primary-200 rounded-xl text-primary-600 inline px-2 py-1 text-xs dark:bg-slate-600 dark:text-gray-300'>{workingDay}</div>
